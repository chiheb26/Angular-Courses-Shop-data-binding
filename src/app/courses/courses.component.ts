...
export class CoursesComponent implements OnInit {
  ...
  courses = [
    ...
    { id:104, name:'Advanced Angular Course', author: 'Steve Smith', duration: 19.5, type: 'Premium', 
      ...
      description: 'In this course you will learn all the concepts of Angular from basic to advance. This course will start teaching you from basics of Angular and as you progress, you will learn all the advanced concepts.'
    },
    { id:105, name:'Advance JavaScript Course', author: 'John Heikela', duration: 60, type: 'Premium', 
      ...
      description: 'In this course you will learn the complete modern JavaScript step by step. This course is purely designed for beginners and teaches you all the concepts of javascript from beginner to advanced level.'
    },
    ...
    { id:108, name:'UX Design Course', author: 'Steve Smith', duration: 19.0, type: 'Premium', 
      ...
      description: 'In this course you will learn about reactive web development using HTML & CSS. This course will start teaching you from basics of HTML & CSS and as you progress, you will learn all the advanced concepts.'
    },
  ...
  courseSelectedRadioButton : string = "All" ;


  onFilterRadioButtonChanged(data : string){
    this.courseSelectedRadioButton=data;
    //console.log(this.courseSelectedRadioButton);
  }
  searchText : string ="";
